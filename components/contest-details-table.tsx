...
const mockParticipants = [
  {
    ...
    status: "Registered",
    score: 95,
    lastSubmission: "2024-09-06 14:30",
  },
  {
    id: 2,
    name: "Bob Smith",
    ...
    status: "In Progress",
    score: 80,
    lastSubmission: "2024-09-06 15:45",
  },
  {
    id: 3,
    name: "Charlie Brown",
    ...
    status: "Completed",
    score: 100,
    lastSubmission: "2024-09-06 16:20",
  },
  {
    id: 4,
    name: "Diana Ross",
  ...
  },
  {
    ...
    status: "In Progress",
    score: 85,
    lastSubmission: "2024-09-06 18:05",
  },
];
      ...
      <nav className="bg-gray-800 p-2 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <span className="text-lg font-semibold">
            Contest: Algorithmic Challenge 2024
          </span>
          <Button variant="ghost" size="icon">
