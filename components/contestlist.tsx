...
import { ChevronLeft, ChevronRight, Search, Bell, User, MoreHorizontal, Eye, Trash2 } from 'lucide-react'

// Mock data for contests
const mockContests = [
  { id: 'C001', name: 'Algorithmic Challenge 2024', organiserId: 'ORG001', organiserName: 'TechCorp', duration: '48 hours' },
  { id: 'C002', name: 'Web Dev Hackathon', organiserId: 'ORG002', organiserName: 'CodeCraft Academy', duration: '24 hours' },
  { id: 'C003', name: 'Data Science Competition', organiserId: 'ORG003', organiserName: 'DataMinds Institute', duration: '72 hours' },
  { id: 'C004', name: 'Mobile App Innovation', organiserId: 'ORG004', organiserName: 'AppGenius', duration: '36 hours' },
  { id: 'C005', name: 'Cybersecurity CTF', organiserId: 'ORG005', organiserName: 'SecureNet', duration: '12 hours' },
]
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={() => handleRemoveContest(contest.id)}>
