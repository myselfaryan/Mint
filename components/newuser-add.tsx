  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-900 text-gray-300 p-6">
      <div className="bg-gray-800 shadow-lg rounded-lg p-8 max-w-md w-full">
        <h1 className="text-2xl font-semibold text-gray-100 mb-6">Create New User</h1>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          {/* Name ID */}
          <div>
            <Label htmlFor="nameId" className="text-gray-300">Name ID</Label>
            <Input
              id="nameId"
              type="text"
              {...register('nameId')}
            ...
            />
            {errors.nameId && (
              <p className="text-red-500 text-sm mt-1">{errors.nameId.message}</p>
            )}
          </div>
