...
const mockUsers = [
  ...
  { id: 'U003', name: 'Charlie Brown', avatar: '/placeholder.svg?height=32&width=32', submissions: 22, pending: 0 },
  { id: 'U004', name: 'Diana Ross', avatar: '/placeholder.svg?height=32&width=32', submissions: 5, pending: 3 },
  { id: 'U005', name: 'Ethan Hunt', avatar: '/placeholder.svg?height=32&width=32', submissions: 19, pending: 1 },
]
