          ...
          <CardContent>
            ...
            >
              <BarChart
                ...
                data={data.submissions.weeklyData}
              >
                <Bar
                  dataKey="steps"
          ...
          <CardContent className="flex flex-1 items-center">
            ...
            >
              <LineChart
                ...
                data={data.upcomingContest.weeklyData}
              >
                <CartesianGrid
                  strokeDasharray="4 4"
                  vertical={false}
            ...
            <div className="grid auto-rows-min gap-2">
              ...
              >
                <BarChart
                  ...
                  data={[
                    {
                      date: data.contestDetails.currentYear.year,
                      steps: data.contestDetails.currentYear.contestsPerDay,
                    },
                  ]}
                >
                  <Bar
            ...
            <div className="grid auto-rows-min gap-2">
              ...
              >
                <BarChart
                  ...
                  data={[
                    {
                      date: data.contestDetails.previousYear.year,
                      steps: data.contestDetails.previousYear.contestsPerDay,
                    },
                  ]}
                >
                  <Bar
            ...
            >
              <BarChart
                ...
                data={[
                  ...
                  {
                    activity: "correct submission",
                    value: (125 / 360) * 100,
                    label: "46/360 ",
                    fill: "var(--color-exercise)",
                  },
                  {
                    activity: "wrong submission",
                    value: (245 / 360) * 100,
                    label: "245/360",
                    fill: "var(--color-move)",
                  },
